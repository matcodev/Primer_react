  ...
  return (
    <div className="cardSection">
      ...
      <div className="cardImgCenter">
        ...
        modalId =   'modal1'
        modalText = 'Modal 1'
        textModal = 'Texto de relleno para Modal 1'
        />
        <CardImage 
        urlImage = {Executive1}
        ...
        modalId =   'modal2'
        modalText = 'Modal 2'
        textModal = 'Texto de relleno para Modal 2'
        />
        <CardImage 
        ...
        modalId =   'modal3'
        modalText = 'Modal 3'
        textModal = 'Texto de relleno para Modal 3'
        />
        <CardImage 
        ...
        modalId =   'modal1'
        modalText = 'Modal 4'
        textModal = 'Texto de relleno para Modal 4'
        />
      </div>
    </div>
  )
